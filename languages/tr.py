...
'Please give some info!': 'Please give some info!',
'please input your password again': 'lütfen parolanızı tekrar girin',
'Please upload a photo of our friend :)!': 'Please upload a photo of our friend :)!',
'Plugins': 'Eklentiler',
...
'You cannot post empty comment!': 'You cannot post empty comment!',
'You need to select the city!': 'You need to select the city!',
'You should be at least 16 to register!': 'You should be at least 16 to register!',
'You visited the url %s': '%s adresini ziyaret ettin',
'Your biography is required for the profile!': 'Your biography is required for the profile!',
}
